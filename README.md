...
# Calculator with transaction history

In this project, I had the opportunity to learn more about "Shape" and "Path" to create the buttons and position them on the screen.


![Demonstração](https://media.giphy.com/media/a1TWFKMlerArDGZgAk/giphy.gif)
